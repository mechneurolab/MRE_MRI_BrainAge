...
def data_splitting(map_type, ids, path='/work/cniel/sw/BrainAge/datasets/'):
    ...
    mask_train_data = train_data_
    mask_val_data = val_data_
    mask_test_data = test_data_
    if map_type == 'Stiffness' or map_type == 'Volume' or map_type =='DR':
        ...
        #     mask_train_data = masking(mask_train_data, train_data_raw[0])
        #     mask_val_data = masking(mask_val_data, val_data_raw[0])
        #     mask_test_data = masking(mask_test_data, test_data_raw[0])
